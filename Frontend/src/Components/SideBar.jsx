      ...
      <aside id="sidebar-multi-level-sidebar" className={`fixed top-16 mt-2 left-0 z-40 w-64 h-screen transition-transform transform ${
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul className="space-y-2 font-medium">
              ...
              {/* Dashboard */}
              <li>
                  <Link to="/login" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" onClick={toggleSidebar}>
